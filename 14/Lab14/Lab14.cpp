...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_LBUTTONDOWN:
    {
        ...
        image1_x = xPos;
        if (type == 0) image1_y = yPos;
        else image1_y = yPos + 50;
        InvalidateRect(hWnd, NULL, TRUE);
    }
    break;
    ...
    case WM_PAINT:
        {
            ...
            if (type == 0) {
                Image0(hdc, image1_x, image1_y, RGB(150, 25, 250));
                Image0(hdc, image1_x + 4, image1_y + 4, RGB(105, 230, 5));
            }
            if (type == 1) {
                Image1(hdc, image1_x, image1_y - 50, RGB(220, 25, 25));
                Image1(hdc, image1_x + 4, image1_y - 54, RGB(35, 230, 230));
            }
