...
void RecursiveImage1_8(HDC hdc, int cx, int cy, int size) {
    Image1(hdc, cx, cy, size);
    if (size < 20) {
        return;
    }
    RecursiveImage1_8(hdc, cx, cy - size, size / 2);
    RecursiveImage1_8(hdc, cx + size, cy, size / 2);
    RecursiveImage1_8(hdc, cx - size, cy, size / 2);
}
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
        ...
        //RecursiveImage1_2(hdc, 200, 160, 80);
        //RecursiveImage1_3(hdc, 200, 160, 80);
        //RecursiveImage1_4(hdc, 200, 160, 80);
        //RecursiveImage1_5(hdc, 200, 160, 80);
        //RecursiveImage1_6(hdc, 200, 160, 80);
        //RecursiveImage1_7(hdc, 200, 160, 80);
        //RecursiveImage1_8(hdc, 200, 160, 80);
